...
public interface ProdutoVariacaoApi {
    ...
    @GetMapping
    ResponseEntity<Page<ProdutoVariacaoResponse>> listar(@ParameterObject ProdutoVariacaoFiltro filtro, @ParameterObject Pageable pageable);
    ...
    @PutMapping("/{id}")
    ResponseEntity<ProdutoVariacaoResponse> atualizar(@PathVariable Long id, @RequestBody ProdutoVariacaoUpdateRequest dto);
